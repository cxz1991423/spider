		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				dragStart: function(e) {
					...
					//借用实例化对象传递opts传递被拖动对象的序号至dropItem方法
					opts.oldIdx = list.draggedItem.index();
				...
				dropItem: function() {
					...
					if (list.draggedItem.attr("data-origpos") != $(lists).index(list) + "-" + $(list.container).children().index(list.draggedItem))
						//额外传递前序号至回调函数方法中
						if (opts.dragEnd.apply(list.draggedItem,[opts.oldIdx]) == false) { //if dragEnd returns false revert order
